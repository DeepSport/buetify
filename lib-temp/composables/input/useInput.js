...
export const StaticUseInputProps = Object.assign(Object.assign({ variant: {
        type: String,
        default: 'is-primary'
    }, type: {
        type: String
...
export function useInput(props, ref) {
    ...
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, toRefs(props)), fieldData.attrs), fieldData.setters), { isExpanded, isFullwidth: isExpanded, messageVariant, setters: fieldData.setters }), model), focus), validate), { iconSize });
}
