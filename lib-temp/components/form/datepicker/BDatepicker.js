...
const BDatepickerPropsDefinition = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, BDropdownPropsDefinition), BDatepickerTablePropsDefinition), UseDisablePropsDefinition), getUseInputPropsDefinition()), { placeholder: {
        type: String
...
function generateInput(props, context, model, dropdownProps) {
    ...
    return h(BInput, Object.assign(Object.assign(Object.assign({}, (isMobile
        ? context.attrs
        : Object.assign(Object.assign({}, context.attrs), { max: formatYYYYMMDD(props.maxDate), min: formatYYYYMMDD(props.minDate) }))), { autocomplete: 'off', type: isMobile ? 'date' : 'text', value: formatDateInput(props, model.modelValue.value), placeholder: props.placeholder, size: props.size, icon: props.icons.calendar, isRounded: props.isRounded, isDisabled: props.isDisabled, isReadonly: props.isReadonly, isLoading: props.isLoading, useNativeValidation: props.useNativeValidation, onFocus: () => {
...
function generateDropdown(props, context, model, data) {
    return h(BDropdown, Object.assign(Object.assign({}, data.toggleProps), { position: props.position, isDisabled: props.isDisabled, isInline: props.isInline, slots: {
