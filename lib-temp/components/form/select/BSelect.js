...
export function getBSelectPropsDefinition(eq) {
    return Object.assign(Object.assign(Object.assign(Object.assign({}, getEqPropsDefinition(eq)), getUseInputPropsDefinition()), DefaultThemePropsDefinition), { items: {
            type: Array,
            required: true
        }, isMultiple: {
            type: Boolean,
...
function generateOptions(props, context, input) {
    ...
    return props.items.map((item, index) => {
        ...
        }, context.slots.default ? context.slots.default({ item, index }) : extractProp(props.itemText, item));
    });
}
...
function generateSelect(props, context, ref, input, themeClasses) {
    ...
    return h('select', Object.assign(Object.assign({}, context.attrs), { ref,
        value, size: props.displayCount, multiple: isMultiple(props, input), class: themeClasses, onBlur: input.onBlur, onFocus: input.onFocus, 'onUpdate:modelValue': input['onUpdate:modelValue'] }), usePlaceholder
