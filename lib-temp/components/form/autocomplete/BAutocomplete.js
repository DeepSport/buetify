...
function defineAutocomplete() {
    defineComponent({
        name: 'b-autocomplete',
        props: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, StaticUseInputProps), getEqPropsDefinition()), getUseThemePropsDefinition(DropdownThemeMap)), getUseModelPropsDefinition('search', 'onUpdate:search')), getUseModelPropsDefinition('selectedItems', 'onUpdate:selectedItems')), { selectedItems: {
                type: Array,
                required: true
            }, items: {
                type: Array,
        ...
        setup(props, { slots }) {
            ...
            const filteredItems = computed(() => { var _a; return props.itemFilter ? props.items.filter(props.itemFilter((_a = searchModel.modelValue.value) !== null && _a !== void 0 ? _a : '')) : props.items; });
