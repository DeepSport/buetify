...
function generateInput(selectionControl) {
    return h('input', Object.assign(Object.assign({}, selectionControl.attrs.value), { onBlur: selectionControl.onBlur, onChange: selectionControl.onChange, onFocus: selectionControl.onFocus }));
}
