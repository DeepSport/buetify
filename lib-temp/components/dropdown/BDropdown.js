...
export const BDropdownPropsDefinition = Object.assign(Object.assign(Object.assign(Object.assign({}, getUseThemePropsDefinition(DropdownThemeMap)), getUseTogglePropsDefinition('isExpanded')), FadeTransitionPropsDefinition), { id: String, isDisabled: {
        type: Boolean,
        default: false
    }, isHoverable: {
        type: Boolean,
...
export default defineComponent({
    ...
    setup(props, { slots }) {
        ...
        const computedId = computed(() => { var _a; return `dropdown-menu-${(_a = props.id) !== null && _a !== void 0 ? _a : id++}`; });
        ...
        const menuToggle = Object.assign(Object.assign({}, toggle), { isOn: displayMenu, isOff: computed(() => !displayMenu.value) });
