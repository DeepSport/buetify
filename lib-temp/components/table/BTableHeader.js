...
export default function BTableHeader(props, { attrs, slots }) {
    var _a;
    const nodes = props.columns.map(column => h(BTableColumn, Object.assign(Object.assign({}, attrs), { slots, key: column.label, column, sortType: props.sortType, onNewSortType: props.onNewSortType, onNewSortColumn: props.onNewSortColumn })));
