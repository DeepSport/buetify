...
export default function BTag(props, { attrs, slots }) {
    ...
    if (!!props.isClosable) {
        ...
        return h((_a = props.tag) !== null && _a !== void 0 ? _a : 'span', attrs, [
            h('span', {
        ...
        return h((_b = props.tag) !== null && _b !== void 0 ? _b : 'span', Object.assign(Object.assign({}, attrs), { class: mergeClasses(attrs.class, [
                'tag',
                props.variant,
                props.size,
                { 'is-rounded': !!props.isRounded }
