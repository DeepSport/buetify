...
const BModalPropsDefinition = Object.assign(Object.assign({}, UsePopupControllerPropsDefinition), { showExit: {
        type: Boolean,
        required: false,
        default: false
    } });
...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        generateModal.value = () => {
            return [
                h(BOverlay, Object.assign(Object.assign({}, context.attrs), { onClick: popup.close }), [generateModalBox(props, context, popup)])
            ];
        };
