...
export default function BButton(props, { slots, attrs }) {
    var _a;
    return h((_a = props.tag) !== null && _a !== void 0 ? _a : 'button', Object.assign(Object.assign({}, attrs), { class: mergeClasses(attrs.class, getButtonClasses(props)) }), slots.default ? slots.default() : []);
}
