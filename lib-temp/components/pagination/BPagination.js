...
export const BPaginationPropsDefinition = Object.assign(Object.assign(Object.assign({}, UsePaginationPropsDefinition), DefaultThemePropsDefinition), { size: {
        type: String,
        default: ''
    }, isSimple: {
        type: Boolean,
...
function generateSimpleSummary(props, pagination) {
    return h('small', { class: 'info' }, props.perPage === 1
        ...
        : `${pagination.after.value + 1} - ${Math.min(pagination.after.value + props.perPage, props.total)} / ${props.total}`);
}
