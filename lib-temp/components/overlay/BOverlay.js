...
export default function BOverlay(props, { attrs, slots }) {
    ...
    if (!!props.isFullscreen) {
        return withDirectives(h('div', Object.assign(Object.assign({}, attrs), { class: mergeClasses(attrs.class, ['b-overlay', props.position]) }), [
            h('div', {
        ...
        return withDirectives(h('div', {
            ...
            h('div', Object.assign(Object.assign({}, attrs), { class: 'b-overlay-background' })),
            h('div', {
