...
import { h } from 'vue';
export default function BTooltip(props, { attrs, slots }) {
    return h(props.tag || 'span', Object.assign(Object.assign({}, attrs), { class: mergeClasses(attrs.class, [
        ...
        ]), 'data-label': props.label }), slots.default ? slots.default() : undefined);
}
