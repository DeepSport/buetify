...
import { Transition, h, defineComponent, shallowRef, withDirectives, resolveDirective } from 'vue';
import { alwaysEmptyArray } from '../../../utils/helpers';
export const BNotificationPropsDefinition = Object.assign(Object.assign(Object.assign({}, UseMessagePropsDefinition), UseNoticePropsDefinition), { isNotice: {
        type: Boolean,
        default: true
    } });
...
function getGenerateNotice(props, context, messageController, noticeController, vShow) {
    return (options) => () => {
        var _a, _b, _c, _d;
