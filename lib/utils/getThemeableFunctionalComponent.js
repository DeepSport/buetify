...
export function getThemeableFunctionalComponent({
  ...
  return (props, context) => {
    ...
    return h((_d = props.tag) !== null && _d !== void 0 ? _d : el, Object.assign(Object.assign({}, context.attrs), {
      class: mergeClasses(getThemeClassesFromContext(themeProps, themeInjection, context), cls)
