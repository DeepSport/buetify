...
export const BLoadingPropsDefinition = Object.assign(Object.assign({}, UsePopupControllerPropsDefinition), {
  isFullscreen: {
    type: Boolean,
    default: false
  },
...
function getGenerateModal(onClick) {
  return () => [h('div', {
    class: 'b-loading-overlay is-active is-fullscreen'
  }, [h('div', {
