import "../../../src/components/navigationDrawer/navigation-drawer.sass";
...
export const BNavigationDrawerPropsDefinition = Object.assign(Object.assign({}, getUseThemePropsDefinition(NavigationDrawerThemeMap)), {
  tag: {
    type: String,
    default: 'nav'
  },
...
function generateMobileDrawer(props, controller, themeClasses, context) {
  return h(SlideRightTransition, [h(BOverlay, {
    class: 'is-left',
