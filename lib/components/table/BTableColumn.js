...
export default function BTableColumn(props, {
  attrs,
  slots
}) {
  ...
  attrs.style = props.column.width !== undefined ? {
  ...
  if (props.column.isSortColumn) {
    children.push(h(VerticalExpansionIcon, {
      isExpanded: props.sortType === 'Ascending'
    }));
  }

  return h('th', props.column.isSortable ? Object.assign(Object.assign({}, attrs), {
