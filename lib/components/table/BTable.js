...
function getBTableRow(rowProps) {
  return (data, index) => Object.freeze(Object.assign(Object.assign({}, data), {
    index,
  ...
  methods: {
    ...
    generateEmptyTable() {
      return h('tbody', [h('tr', {
        ...
        colspan: this.numberOfVisibleColumns
      }, this.$slots.empty && this.$slots.empty())])]);
    },

    generateRow(row, index) {
      return h(BTableRowElement, Object.assign({
        key: row.id,
        class: {
    ...
    generateNonEmptyTable() {
      if (this.$slots.row) {
        return h('tbody', this.newRows.map((row, index) => h('tr', {
          key: row.id
        }, this.$slots.row({
          row,
          index,
    ...
    generateTableFooter() {
      return h('tfoot', [h('tr', {
        class: 'table-footer'
      }, this.hasCustomFooterSlot() ? this.$slots.footer : [h('th', {
        colspan: this.numberOfVisibleColumns
      }, this.$slots.footer())])]);
    },
