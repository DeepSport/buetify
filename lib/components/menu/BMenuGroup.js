...
export default defineComponent({
  name: 'b-menu-group',
  props: Object.assign(Object.assign({}, getUseTogglePropsDefinition('isExpanded')), {
    menuLabelClass: {
      type: String,
      default: ''
    },
  ...
  setup(props, {
    ...
    return () => h('section', [h('button', Object.assign(Object.assign({
      class: mergeClasses('is-flex flex-direction-row justify-content-space-between align-items-center is-fullwidth', props.menuLabelClass)
    }, toggle.listeners), toggle.attrs.value), [slots['menu-label'] && slots['menu-label'](), h(VerticalExpansionIcon, {
      isExpanded: toggle.isOn.value
    })]), h(VerticalExpandTransition, [withDirectives(h(BMenuList, {
