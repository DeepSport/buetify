...
export default function (_, {
  ...
  return h('header', Object.assign(Object.assign({}, attrs), {
    class: mergeClasses(attrs.class, 'b-app-header is-flex flex-direction-row justify-content-center align-items-center')
  }), [generateNavigationButton(navigationDrawerController, slots), generateMainSlot(navigationDrawerController, !navigationDrawerController.isVisible.value, slots)]);
}
