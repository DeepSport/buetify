import "../../../../src/components/form/numberInput/b-numberinput.sass";
...
const BNumberInputPropsDefinition = Object.assign(Object.assign({}, getUseInputPropsDefinition()), {
  modelValue: {
    type: Number,
    default: 0
  },
...
export function getNumberInputIcons(icons) {
  return Object.assign(Object.assign({}, DEFAULT_NUMBER_INPUT_ICONS), icons);
}
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      ...
      const nodes = props.displayControls ? [generateControl(props, data, true), generateInput(props, model, data), generateControl(props, data, false)] : [generateInput(props, model, data)];
      return h('div', {
        class: ['b-number-input field', getFieldClasses(props.controlsPosition)]
      }, nodes);
    };
  }
