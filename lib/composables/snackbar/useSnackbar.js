...
export const SnackbarPropsDefinition = Object.assign(Object.assign({}, UseNoticePropsDefinition), {
  actionText: {
    type: String,
    default: 'OK'
  },
...
const DEFAULT_SNACKBAR_PROPS = Object.assign(Object.assign({}, DEFAULT_USE_NOTICE_PROPS), {
...
function generateMessage(slots, message) {
  return h('p', {
    class: 'text'
  }, slots.message ? slots.message() : message);
}
...
function getGenerateSnackbar(props, slots, noticeController) {
  return options => () => {
    ...
    return [h('article', {
      ...
      role: 'alert'
    }, [generateMessage(slots, (_a = options.message) !== null && _a !== void 0 ? _a : props.message), generateAction(props, slots, noticeController, options)])];
  };
}
