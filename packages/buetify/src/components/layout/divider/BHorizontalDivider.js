...
function BHorizontalDivider(props, _a) {
    var _b, _c, _d;
    var attrs = _a.attrs;
    ...
    attrs["class"] = mergeClasses_1.mergeClasses(attrs["class"], __spreadArrays(['is-divider'], themeClasses.value));
    if (props.text) {
        attrs['data-content'] = props.text;
    }
    return vue_1.h((_d = props.tag) !== null && _d !== void 0 ? _d : 'div', attrs);
}
exports["default"] = BHorizontalDivider;
