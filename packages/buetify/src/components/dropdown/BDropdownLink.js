    ...
    setup: function (props, _a) {
        ...
        return function () {
            ...
            return vue_1.h((_a = props.tag) !== null && _a !== void 0 ? _a : 'li', {
                ...
                vue_1.h('a', __assign(__assign({}, attrs), { "class": __spreadArrays(['dropdown-item dropdown-link'], themeClasses.value, [{ 'is-active': props.isActive }]) }), slots["default"] && slots["default"]())
            ]);
        };
    }
});
